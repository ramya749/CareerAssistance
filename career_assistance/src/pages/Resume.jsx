...
function Resume() {
 ...
 <Row className="mb-3" style={{ marginLeft: "85px" }}>
                        <Col sm="6">
                            <Form.Control
                                style={{ width: "100%" }}
                                type="text"
                                ...
                                onChange={(e) => setlanguageknownValue(e.target.value)}
                            />
                        </Col>
                        <Col sm="1" className="d-flex align-items-end">
                            <Button onClick={addlanguageValue} variant="warning">+</Button>
                        </Col>
                    </Row>
                    ...
                    <ul>
                        {inputValue.languageknown?.map((v) =>
                            <li style={{ width: "400px", marginLeft: "100px" , color:"white"}}><i>{v}</i>
                                <Button variant='danger' onClick={() => deletelanguage(v)}>x</Button>
                            </li>
                        )}
                    </ul>

                    
                    <h3 style={{ width: "400px", marginLeft: "100px", color: "white" }}><i>Skills</i></h3>
                    <Row className="mb-3" style={{ marginLeft: "85px" }}>
                        <Col sm="6">
                            <Form.Control
                                style={{ width: "100%" }}
                        ...
                        <Col sm="1" className="d-flex align-items-end">
                            <Button onClick={addskillValue} variant="warning">+</Button>
                        </Col>
                    </Row>
                    <ul>
                        ...
                        {inputValue.skills?.map((v) =>
                            <li style={{ width: "400px", marginLeft: "100px", color:"white" }}><i>{v}</i>
                                <Button variant='danger' onClick={() => deleteskill(v)} >x</Button>
                            </li>   
                        )}
                    </ul>

                    <h3 style={{ width: "400px", marginLeft: "100px", color: "white" }}><i>Hobbies</i></h3>
 ...
 <Row className="mb-3" style={{ marginLeft: "85px" }}>
                        ...
                        <Col sm="1" className="d-flex align-items-end">
                            <Button onClick={addhobbiesValue} variant="warning">+</Button>
                        </Col>
                    </Row>
                    ...
                    <ul>
                        {inputValue.hobbies?.map((v) =>
                            <li style={{ width: "400px", marginLeft: "100px", color:"white" }}><i>{v}</i>
                                <Button variant='danger' onClick={() => deletehobbies(v)}>x</Button>
                            </li>
                        )}
                    </ul>
                </Col>
